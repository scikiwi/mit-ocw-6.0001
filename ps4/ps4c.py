...
# Collaborators: -
# Time Spent: 1 hour 53 minutes of focused time,  2 hours 11 minutes with breaks 
...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        '''
        transpose_dict = {consonant:consonant for consonant in CONSONANTS_LOWER + CONSONANTS_UPPER} 
...
if __name__ == '__main__':
    ...
    # test case 1
    message = SubMessage("To be or not to be, that is the question.")
    permutation = "uoiae"
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Expected encryption:", "Ta bo ar nat ta bo, thut is tho qeostian.")
    print("Actual encryption:", message.apply_transpose(enc_dict))
    enc_message = EncryptedSubMessage(message.apply_transpose(enc_dict))
    print("Decrypted message:", enc_message.decrypt_message())
    ...
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Expected encryption:", "Uraso! Uwuko! Und stip nit, ental tho giul as rouchod.")
    print("Actual encryption:", message.apply_transpose(enc_dict))
    enc_message = EncryptedSubMessage(message.apply_transpose(enc_dict))
    print("Decrypted message:", enc_message.decrypt_message())
